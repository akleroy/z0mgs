...
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
; REMOVE A SINGLE BACKGROUND VALUE FIRST
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
...
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
; PLANE FIT IF REQUESTED OR WISE3 OR WISE4
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
...
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
; RECENTER IMAGE SO HISTOGRAM PEAKS AT ZERO
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
...
; &%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%&%
  ...
  std = stddev(bksub[where(bkreg_mask eq 0)],/nan)
  rms = mad(bksub[fit_ind])
  rej_frac = (total(mask)*1. - total(bkreg_mask)*1.)/(n_elements(mask)*1. - total(bkreg_mask)*1.)
